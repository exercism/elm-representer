...
suite : Test
suite =
    describe "Normalizing custom types"
        [ test "shoud normalize Name and ValueConstructors" <|
            \_ ->
                givenElmCodeOf "type FirstName = FirstName String"
                    |> whenNormalize
                    |> thenContains "type Identifier_1\n=Identifier_1 String"
        , test "shoud normalize generic type parameters" <|
            \_ ->
        ...
        , test "shoud ignore typeclass type parameters" <|
            \_ ->
